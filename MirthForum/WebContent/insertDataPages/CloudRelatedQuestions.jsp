...
<%
  ...
  //  System.out.println("QuestionHeader : "+questionHeader);
    ...
    String cloudUpdate = "insert into cloudfaq (Header,Question,PostingName) values ('"+questionHeader+"','"+completeQuestion+"','"+pName+"')";
    int insertHealth= stat2.executeUpdate(cloudUpdate);%>
<%
    response.sendRedirect("fetchDataPages/cloudRelatedFetch.jsp");
%>